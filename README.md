...
A data set generated by emulating photometry and metacal results, based directly on CosmoDC2, is available on NERSC in:

    /global/projecta/projectdirs/lsst/groups/WL/users/zuntz/data/cosmoDC2-1.1.4-image-inputs

A data set based on running metacal for real on mock DC2 images is available here:

    /global/projecta/projectdirs/lsst/groups/WL/users/zuntz/data/metacal-2.1i-dr1b-inputs

Though note that a flagging issue means it has very few galaxies unflagged (~ 4 / arcmin^2).
