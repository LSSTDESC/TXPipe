...
- :ref:`Photo-z Files`: per-galaxy photo-z PDFs and ensemble (stacked) per-bin n(z) information.
...
.. toctree::
    :maxdepth: 1
    :caption: Collected details on all file types

    file_details/binned
    file_details/clusters
    file_details/exposures
    file_details/generic_shear
    file_details/hsc
    file_details/lensfit
    file_details/maps
    file_details/metacal
    file_details/metadata
    file_details/metadetect
    file_details/photometry
    file_details/photoz
