...
types = {
    standard_types.galaxy_shear_xi_plus: (
        Types.galaxy_shear_plus_real,
        Types.galaxy_shear_plus_real,
    ),
    standard_types.galaxy_shear_xi_minus: (
        Types.galaxy_shear_minus_real,
        Types.galaxy_shear_minus_real,
    ),
    standard_types.galaxy_shearDensity_xi_t: (
        Types.galaxy_position_real,
        Types.galaxy_shear_plus_real,
    ),
    standard_types.galaxy_density_xi: (
        Types.galaxy_position_real,
        Types.galaxy_position_real,
    ),
}
...
def choose_kernel_and_bins(tracer):
    ...
    if name == 'lens':
        ...
        raise ValueError(
            f"Not sure how to convert tracer {tracer} to a 2pt kernel index"
        )
...
for dt in s.get_data_types():
    ...
    for d in data:
        ...
        builder.add_data_point(
            kernel1, kernel2, stype1, stype2, bin2, bin1, ang, angbin, d.value
        )
