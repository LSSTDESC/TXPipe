...
class TXLensMaps(TXBaseMaps):
    ...
    def finalize_mappers(self, pixel_scheme, mappers):
        ...
        pix, ngal, weighted_ngal, _, _, _, _,  = mapper.finalize(self.comm)
        maps = {}
...
class TXDensityMaps(PipelineStage):
    ...
    def run(self):
        ...
        for i, ng in enumerate(ngal_maps):
            ...
            delta_map[mask_copy>0] = ng[mask_copy>0]/mask[mask_copy>0] # Assuming that the weights do not include the mask
