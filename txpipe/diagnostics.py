        ...
        while True:
            ...
            for i in range(bins):
                ...
                if self.config['shear_catalog_type'] == 'metacal':
                    ...
                    S = calculate_selection_response(
                        data['mcal_g1'][qual_cut],
                        data['mcal_g2'][qual_cut],
                        w1_1p,
                        w1_2p,
                        w1_1m,
                        w1_2m,
                    ...
                    R = calculate_shear_response(
                        data['mcal_g1_1p'][qual_cut],
                        data['mcal_g1_2p'][qual_cut],
                        data['mcal_g1_1m'][qual_cut],
                        data['mcal_g1_2m'][qual_cut],
                        data['mcal_g2_1p'][qual_cut],
                        data['mcal_g2_2p'][qual_cut],
                        data['mcal_g2_1m'][qual_cut],
                        data['mcal_g2_2m'][qual_cut],
                        delta_gamma,
                    )
                    g1, g2 = apply_metacal_response(
                        R,
                        S,
                        data['mcal_g1'][qual_cut][w1],
                        data['mcal_g2'][qual_cut][w1],
                    )
                elif self.config['shear_catalog_type'] == 'lensfit':
                    g1, g2, weight, one_plus_K = apply_lensfit_calibration(
                        data['g1'][qual_cut][w1],
                        data['g2'][qual_cut][w1],
                        data['weight'][qual_cut][w1],
                    )
                else:
                    raise ValueError(
