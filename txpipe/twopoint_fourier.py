...
from descformats.tx import MetacalCatalog, TomographyCatalog, RandomsCatalog, YamlFile, SACCFile, DiagnosticMaps
import numpy as np
...
class TXTwoPointFourier(PipelineStage):
    ...
    inputs = [
        ...
        ('mask',DiagnosticMaps), #Mask (generated by TXSysMapMaker)
    ]
    outputs = [
