...
class TXCosmoDC2MockOld(PipelineStage):
    """
...
class TXBuzzardMockOld(TXCosmoDC2MockOld):
    """
...
class TXGaussianSimsMockOld(TXCosmoDC2MockOld):
    """
...
class TXMockTruthPZOld(PipelineStage):
    name = "TXMockTruthPZOld"
    parallel = False
