...
class TXCosmoDC2Mock(PipelineStage):
    ...
    def make_mock_metadetect(self, data, photo):
        ...
        output = {
            ...
            "ns/mag_err_r": photo["mag_r_err"],
            "ns/mag_err_i": photo["mag_i_err"],
            "ns/mag_err_z": photo["mag_z_err"],
    ...
    def make_mock_metacal(self, data, photo):
        ...
        output = {
            ...
            "mag_i": photo["mag_i"],
            "mag_z": photo["mag_z"],
            "mag_err_r": photo["mag_r_err"],
            "mag_err_i": photo["mag_i_err"],
            "mag_err_z": photo["mag_z_err"],
            ...
            "mag_err_r_1p": photo["mag_r_err"],
            "mag_err_r_2p": photo["mag_r_err"],
            "mag_err_r_1m": photo["mag_r_err"],
            "mag_err_r_2m": photo["mag_r_err"],
            "mag_err_i_1p": photo["mag_i_err"],
            "mag_err_i_2p": photo["mag_i_err"],
            "mag_err_i_1m": photo["mag_i_err"],
            "mag_err_i_2m": photo["mag_i_err"],
            "mag_err_z_1p": photo["mag_z_err"],
            "mag_err_z_2p": photo["mag_z_err"],
            "mag_err_z_1m": photo["mag_z_err"],
            "mag_err_z_2m": photo["mag_z_err"],
            # Fixed PSF parameters - all round with same size
            "psf_g1": zero,
            "psf_g2": zero,
